...
io.on('connection', (socket) => {
    ...
    socket.on('change_username', (data) => {
        ...
        io.sockets.emit('get_user_list', userlist);
        io.sockets.emit('add_system_message', socket.username + " сменил имя на " + data.username);
    ...
    socket.on('new_message', (data) => {
        ...
        io.sockets.emit('add_mess', { message: data.message, username: socket.username, id: socket.id });
